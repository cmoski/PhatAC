...
--
-- Table structure for table `tele_locations`
--

CREATE TABLE IF NOT EXISTS `tele_locations` (
  `ID` int(11) NOT NULL,
...
INSERT INTO `tele_locations` (`ID`, `Description`, `Command`, `Landblock`, `Position_X`, `Position_Y`, `Position_Z`, `Orientation_W`, `Orientation_X`, `Orientation_Y`, `Orientation_Z`) VALUES
...
--
-- Indexes for table `tele_locations`
--
